...
<div>
	<h3>* 회/원/수/정 *</h3>
<%
	dto=dao.read((String)session.getAttribute("s_id")); // loginProc.jsp 로그인 성공 참조
	if(dto==null) {
		out.print("회원 정보 없음");
...
%>		
	...
	<tr>
	    ...
	    <td style="text-align: left">
	    	<input type="text" name="id" id="id" size="15" value="<%=(String)session.getAttribute("s_id") %>" readonly> ID수정불가
	    </td>
	</tr>
	<tr>
	    <th>비밀번호</th>
	...
	<tr>
	    <th>이메일</th>
	    <td style="text-align: left">
	      <input type="email" name="email" id="email" value="<%=dto.getEmail()%>" size="30" readonly>
